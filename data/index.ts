...
export const navItems = [
  ...
  export const gridItems = [
    ...
    {
      id: 5,
      title: "Currently building a prototype for a centralized EMR system",
  ...
  export const projects = [
    ...
    },
    {
      id: 4,
      title: "Button Credit",
      des: "Button is a credit card management app that helps users track their spending, manage their credit cards, and stay on top of their finances.",
      img: "/image.png",
      iconLists: ["/re.svg", "/css-icon.svg", "/js.svg", "/next.svg", "/c.svg"],
      link: "https://button-credit.vercel.app/",
    },
    {
      id: 5,
      title: "EasyStudy",
      des: "A web app with integrated AI that helps students and other to read notes, practice quizes and generate flashcards.",
      img: "/easystudy.png",
      iconLists: ["/re.svg", "/drizzle.svg", "/js.svg", "/next.svg", "/c.svg",],
      link: "https://easyaistudy.vercel.app/",
    },
    // {
    //   id: 6,
